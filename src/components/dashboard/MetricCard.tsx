...
export function MetricCard({ title, value, subtitle, change, isHighlighted = false, className = "", onClick }: MetricCardProps) {
  return (
    <Card
  onClick={onClick}
  className={`
...
>
      <CardContent className="h-full flex flex-col justify-between p-4 relative">
        ...
        <h3 className={`text-xs font-medium text-left ${
        ...
        <div className="flex flex-col">
          ...
          {subtitle && (
            <p className={`text-lg font-medium text-left mt-1 ${
